    ...
    'hestia_section_content_fs', function (value) {
        ...
        value.bind(
            function( to ) {
                ...
                var arraySizes = {
                    size3: { selectors: 'section.hestia-features .hestia-info p, section.hestia-shop .card-description p', values: [16,16,16], limit: 12, correlation: [3,3,3] },
                    size2: { selectors: 'section.hestia-team p.card-description, section.hestia-pricing p.text-gray, section.hestia-testimonials p.card-description, section.hestia-blogs p.card-description, .section.related-posts p.card-description, .hestia-contact p', values: [14,14,14], limit: 12, correlation: [3,3,3] },
