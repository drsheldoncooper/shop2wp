...
class Themeisle_Customizer_Notify {
	...
	public function themeisle_customizer_notify_scripts_for_customizer() {
		...
		wp_enqueue_style( 'ti-customizer-notify-customizer-css', get_template_directory_uri() . '/ti-notifications/ti-customizer-notify/css/ti-customizer-notify-customizer.css', array(), HESTIA_VERSION );
		...
		wp_enqueue_script( 'ti-customizer-notify-customizer-js', get_template_directory_uri() . '/ti-notifications/ti-customizer-notify/js/ti-customizer-notify-customizer.js', array( 'customize-controls' ), HESTIA_VERSION );
		wp_localize_script(
	...
	public function themeisle_customizer_notify_customize_register( $wp_customize ) {
		 ...
		 */
		require_once get_template_directory() . '/ti-notifications/ti-customizer-notify/class-themeisle-customizer-notify-section.php';
