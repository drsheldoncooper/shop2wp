...
( function( $ ) {
	...
	$( document ).on(
		'DOMNodeInserted', '.customize-partial-edit-shortcut', function () {
            ...
            /**
			 * Insert Menu Shortcut before primary menu.
             */
			var primaryMenu = $('.navbar-nav');
            if( ! primaryMenu.prev().hasClass('menu-shortcut') ){
			...
			$( this ).on(
				'click', function(){
                    ...
                    /**
					 * If clicked on menu shortcut, send preview action.
                     */
                    if($(this).hasClass('menu-shortcut')){
