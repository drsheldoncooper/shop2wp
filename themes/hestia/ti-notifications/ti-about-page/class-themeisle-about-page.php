...
if ( ! class_exists( 'Themeisle_About_Page' ) ) {
	...
	require_once( get_template_directory() . '/ti-notifications/functions/ti-notifications-utils.php' );
	...
	class Themeisle_About_Page {
		...
		public function get_plugin_icon( $arr ) {
			...
			if ( ! empty( $arr['svg'] ) ) {
				...
				$plugin_icon_url = get_template_directory_uri() . '/ti-notifications/ti-about-page/images/placeholder_plugin.png';
			}
		...
		public function style_and_scripts( $hook_suffix ) {
			...
			wp_enqueue_style( 'ti-about-page-css', get_template_directory_uri() . '/ti-notifications/ti-about-page/css/ti_about_page_css.css', array(), HESTIA_VERSION );

			if ( 'appearance_page_' . $this->theme_slug . '-welcome' == $hook_suffix ) {

				wp_enqueue_script( 'ti-about-page-js', get_template_directory_uri() . '/ti-notifications/ti-about-page/js/ti_about_page_scripts.js', array( 'jquery' ), HESTIA_VERSION );
