...
class Hestia_Import_Zerif extends Hestia_Import_Utilities {
	...
	private function import_zerif_about() {
		...
		/* Left content */
		$left_content = ! empty( $this->previous_theme_content['zerif_aboutus_biglefttitle'] ) ? $this->previous_theme_content['zerif_aboutus_biglefttitle'] : '';

		/* Center content */
		$center_content = ! empty( $this->previous_theme_content['zerif_aboutus_text'] ) ? $this->previous_theme_content['zerif_aboutus_text'] : '';
		...
		if ( ! empty( $about_content ) ) {
			...
			hestia_sync_content_from_control( $about_content );
		}
	}
	...
	private function import_zerif_bottom_button_ribbon() {
		...
		if ( ! empty( $hestia_about ) ) {
			...
			hestia_sync_content_from_control( $hestia_about );
		}
	}
