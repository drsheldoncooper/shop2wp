...
class Hestia_Hiding_Section extends WP_Customize_Section {
	...
	public function enqueue() {
		wp_enqueue_script( 'hestia-hiding-section', get_template_directory_uri() . '/inc/customizer-hiding-section/js/script.js', array( 'jquery' ), HESTIA_VERSION, true );
		wp_enqueue_style( 'hestia-hiding-section-style', get_template_directory_uri() . '/inc/customizer-hiding-section/css/style.css', array(), HESTIA_VERSION );
	}
