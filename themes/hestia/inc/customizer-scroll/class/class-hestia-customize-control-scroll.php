 ...
 * @access public
 */
class Hestia_Customize_Control_Scroll {
	...
	public function enqueue() {
		wp_enqueue_script( 'hestia-scroller-script', get_template_directory_uri() . '/inc/customizer-scroll/js/script.js', array( 'jquery' ), HESTIA_VERSION, true );
	}
	...
	public function helper_script_enqueue() {
		wp_enqueue_script( 'hestia-scroller-addon-script', get_template_directory_uri() . '/inc/customizer-scroll/js/customizer-addon-script.js', array( 'jquery' ), HESTIA_VERSION, true );
	}
}
